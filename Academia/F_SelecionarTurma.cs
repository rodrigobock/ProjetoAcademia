...
namespace Academia
{
    public partial class F_SelecionarTurma : Form
    {
        ...
        private void dgv_turmas_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                formNovoAluno.tb_turma.Text = dgv_turmas.Rows[dgv.SelectedRows[0].Index].Cells[1].Value.ToString();
                formNovoAluno.tb_turma.Tag = dgv_turmas.Rows[dgv.SelectedRows[0].Index].Cells[0].Value.ToString();
                Close();
            }
        }
    }
